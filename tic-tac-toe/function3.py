...
game.").upper()
        ...
        elif len(play) != 2 or play[0] not in ["A", "B", "C"] or play[1] not in ["1", "2", "3"]:
            print("Wrong input.")
        else:
            if play[0] == "A":
                move.append(0)
...
if __name__ == "__main__":
    ...
    print(coordinates)
    # the only possible returned value can be (0,2) or (1,1) or (1, 2) or (2,2) 
    #  because they are the only valid ones
